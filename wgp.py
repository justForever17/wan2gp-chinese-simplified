...
def create_ui():
    ...
    with gr.Blocks(css=css, js=js,  theme=theme, title= "WanGP") as main:
        ...
        # Enable plugins to access components
        app.run_component_insertion({
            'video_gen': video_generator_tab,
            'main': main,
            'main_tabs': main_tabs,
            'loras_multipliers': generator_tab_components['loras_multipliers'],
            'loras_choices': generator_tab_components['loras_choices'],
            'guidance_phases': generator_tab_components['guidance_phases'],
            'num_inference_steps': generator_tab_components['num_inference_steps'],
        })
